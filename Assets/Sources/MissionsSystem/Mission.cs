...
namespace Sources.MissionsSystem
{
    internal sealed class Mission : IMission
    {
        ...
        private readonly List<IHero> _heroesToUnlock;
        ...
        public Mission(string description, string playingDescription,
            ...
            int playerHeroesAmount, List<IHero> heroesToUnlock)
        {
            ...
            _heroesToUnlock = heroesToUnlock;
        }
        ...
        public IReadOnlyList<IHero> HeroesToUnlock => _heroesToUnlock;
